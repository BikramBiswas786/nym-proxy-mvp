...
Write-Host ""
Write-Host "=== Nym Proxy - FULL AUTOMATION (Windows) ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host ""
Write-Host "Step 3: Merge and Deploy" -ForegroundColor Cyan
Write-Host "========================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  powershell -ExecutionPolicy Bypass -File scripts\windows\test-mixnet.ps1"
Write-Host ""
